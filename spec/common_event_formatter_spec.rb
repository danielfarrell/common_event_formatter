...
describe "CommonEventFormatter" do
  ...
  describe "call" do
    ...
    it "should load call create_event with a hash" do
      ...
      subject.should_receive(:create_event).with({:level => @severity, :time => @time, :app => "test_app", :pname => @progname, :msg => @msg})
  ...
  describe "create_event" do
    before do
      ...
      @msg = "This is a test log"
      @app = "test_app"
      @hash = {:level => @severity, :time => @time, :app => @app, :pname => @progname, :msg => @msg}
    end
